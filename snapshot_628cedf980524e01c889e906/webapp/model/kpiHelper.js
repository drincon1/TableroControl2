...
// We copy the dimension value into a new object to display something mean
...
* @param {string} sModelName the name of the model on the view
...
* @param {Function} fnCallback function to call with the created JSONModel
*/
getKPIModel: function (sName, oChart, sModelName, sEntityName, aDimensions, mMeasureCalculation, fnSortAndFilter, fnCallback) {
...
if(oChart.getBinding("data") !== undefined) {
oChart.getBinding("data").attachDataReceived(performRead);
}
...
var oModel = oChart.getModel(sModelName);
